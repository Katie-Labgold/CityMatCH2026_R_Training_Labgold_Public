---
title: "Guide to Report Creation: U.S. Territory Preterm Births during 2020-2023"
...
<button onclick="toggleFig('fig.pt3')">Figure 3.1 Output</button>
<div id="fig.pt3" style="display:none;">
```{r, echo = F}
fig.pt3 <- year.rate20_24 %>%
            rename("Preterm Births per 100 Live Births" = "preterm_rate_per100") %>% # Rename variable 
            flextable() %>%
...
<button onclick="toggleFig('fig.pt3_2')">Figure 3.2 Code</button>
<div id="fig.pt3_2" style="display:none;">
```{r, eval = F}
fig.pt3_2 <- fig.pt3 %>%
...
<button onclick="toggleFig('fig.pt3_3')">Figure 3.3 Code</button>
<div id="fig.pt3_3" style="display:none;">
```{r, eval = F}
fig.pt3_3 <- fig.pt3_2 %>%
...
<button onclick="toggleFig('fig.pt3_4')">Figure 3.4 Code</button>
<div id="fig.pt3_4" style="display:none;">
```{r, eval = F}
fig.pt3_4 <- fig.pt3_3 %>%
...
<button onclick="toggleFig('fig.pt3_4_output')">Figure 3.4 Output</button>
<div id="fig.pt3_4_output" style="display:none;">
```{r, echo = F}
fig.pt3_4 <- fig.pt3_3 %>%
              align(align = "center", part = "all")
...
<button onclick="toggleFig('fig.pt3.2_output')">Figure 3 Part 2 Output</button>
<div id="fig.pt3.2_output" style="display:none;">
```{r, echo = F, warning = F}
fig.pt3.2 <- year.rate20_24 %>%
                filter(`Birth Year` != "Overall 2020-2024") %>% # remove Overall row
                mutate(`Birth Year` = as.numeric(`Birth Year`)) %>% # ggplot2 wants year to be ordered, so I transform it a numeric type
...
<button onclick="toggleFig('fig.pt3.2_2_code')">Figure 3.2 Part 2 Code</button>
<div id="fig.pt3.2_2_code" style="display:none;">
```{r, eval = F}
fig.pt3.2_2 <- year.rate20_24 %>%
...
<button onclick="toggleFig('fig.pt3.2_2_output')">Figure 3.2 Part 2 Output</button>
<div id="fig.pt3.2_2_output" style="display:none;">
```{r, echo = F, warning = F}
fig.pt3.2_2 <- year.rate20_24 %>%
                  filter(`Birth Year` != "Overall 2020-2024") %>%
                  mutate(`Birth Year` = as.numeric(`Birth Year`)) %>% 
...
<button onclick="toggleFig('fig.pt3.2_3_code')">Figure 3.3 Part 2 Code</button>
<div id="fig.pt3.2_3_code" style="display:none;">
```{r eval = F}
fig.pt3.2_2 +
...
<button onclick="toggleFig('fig.pt3.2_3_output')">Figure 3.3 Part 2 Output</button>
<div id="fig.pt3.2_3_output" style="display:none;">
```{r echo = F, warning = F}
fig.pt3.2_2 +
    geom_point( # add a new geom_point
    data = year.rate20_24 %>% filter(`Birth Year` == "2024"), # filtered only to 2024
